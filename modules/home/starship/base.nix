...
in
  # Apply mkDefault to all leaf values recursively
  # This allows presets to override any base setting without conflicts
  mapAttrsRecursive (path: value: mkDefault value) baseConfig
